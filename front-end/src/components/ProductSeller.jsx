    ...
    <div className='group px-5 py-10'>
        ...
        <div className='group-hover:shadow-2xl transition-all duration-700 ease-in-out'>
            <div className='w-full h-full relative'>
                ...
                <div className=' absolute flex justify-center items-center   top-0 right-0 w-0 h-full bg-[#beb996] bg-opacity-80
            ...
            <div className='bg-[#f5f6fb] py-3 flex flex-col items-center text-center'>
